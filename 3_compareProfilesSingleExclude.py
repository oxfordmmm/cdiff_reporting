...
def compareHash(input_hash, compareOut, hash_folder, distance_cutoff, min_distance_cutoff):
...
if __name__ == "__main__":
	...
	parser.add_option( '-d', '--distance_cutoff', action = 'store', type='int', dest = 'distance_cutoff', default = 50)
	...
	compareHash(opts.input_hash, opts.output, opts.hash_folder, opts.distance_cutoff, opts.min_distance_cutoff)
